...
<script>
	...
	const map = L.map('map').setView([-7.7633695,110.407394], 15);
    ...
    const marker6 = L.marker([-7.7648826,110.4060936]).addTo(map)
		.bindPopup('<b>Djuragan Kamar Kayon</b><br />penginapan').openPopup();

    const marker5 = L.marker([-7.7634638,110.4065528]).addTo(map)
		.bindPopup('<b>D Paragon UPN Yogyakarta</b><br />penginapan').openPopup();

    const marker4 = L.marker([-7.7612273,110.4112594]).addTo(map)
		.bindPopup('<b>Hotel Pondok Anggun</b><br />penginapan').openPopup();

    const marker3 = L.marker([-7.7597294,110.403903]).addTo(map)
		.bindPopup('<b>Hartono Inn Seturan RedPartner</b><br />penginapan').openPopup();

    const marker2 = L.marker([-7.7638252,110.4121289]).addTo(map)
		.bindPopup('<b>RedDoorz Plus</b><br />penginapan').openPopup();

    const marker1 = L.marker([-7.7622644,110.4092163]).addTo(map)
		.bindPopup('<b>UPN "Veteran" Yogyakarta</b>').openPopup();
	...
	map.on('click',function(e){
        ...
        L.Routing.control({
            waypoints:[
                L.latLng(-7.7622644,110.4092163),
